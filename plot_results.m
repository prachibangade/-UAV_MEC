...
% PLOT_RESULTS  Generate IEEE-quality figures from the results struct.
...
% =====================================================================
% FIG 8: adaptive vs uniform relay (the novelty)
% =====================================================================
f = figure('Position',[350 100 560 420]);
vals = [results.E_prop, results.E_uniform;
        results.Eb_prop.E4, results.Eb_uniform.E4];
b = bar(vals);
b(1).FaceColor = C.proposed;  b(2).FaceColor = C.uniform;
set(gca,'XTickLabel',{'Total energy','Relay energy E4'},'FontSize',fs-1);
ylabel('Energy (J)','FontSize',fs);
title('Adaptive vs Uniform Relay Scheduling','FontSize',fs+1);
legend({'Adaptive (proposed)','Uniform (baseline)'},'Location','best','FontSize',fs-2);
grid on; box on;
...
% extract [E1 E2 E3 E4 E5] as a row vector
